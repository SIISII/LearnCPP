...
ID3D10EffectVectorVariable  *g_pLight_Color     = nullptr;
ID3D10EffectVectorVariable  *g_pLight_Position  = nullptr;
ID3D10EffectVectorVariable  *g_pLight_Direction = nullptr;

ID3D10EffectScalarVariable  *g_pLight_Phi       = nullptr;
ID3D10EffectScalarVariable  *g_pLight_Theta     = nullptr;
    ...
    int        nCmdShow)
{
    ...
    g_hWnd = CreateWindowW(
        Class_Name,
        L"DirectX 10: Освещение прожектором",
        WS_OVERLAPPEDWINDOW,
        CW_USEDEFAULT,
        CW_USEDEFAULT,
...
void  Init_Direct3D10_1()
{
    ...
    g_pLight_Direction = g_pEffect->GetVariableByName("Light_Direction")->AsVector();
    g_pLight_Phi       = g_pEffect->GetVariableByName("Light_Phi")->AsScalar();
    g_pLight_Theta     = g_pEffect->GetVariableByName("Light_Theta")->AsScalar();
...
void  Render_Scene()
{
    ...
    Angle += static_cast<float>(Delta_Time) / 10000.0f;
    ...
    float  Light_Position[4]  = { 0.0f, 0.0f, -1.5f, 1.0f };
    float  Light_Direction[4] = { 0.0f, 0.0f, 10.0f, 1.0f };
    float  Light_Phi          = static_cast<float>(D3DXToRadian(50.0f));
    float  Light_Theta        = static_cast<float>(D3DXToRadian(25.0f));
    ...
    g_pLight_Phi->SetFloat(Light_Phi);
    g_pLight_Theta->SetFloat(Light_Theta);
